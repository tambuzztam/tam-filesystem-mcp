...
export class TemplateProcessor {
   ...
   */
  private createVariableMap(variables: Record<string, any>): Record<string, TemplateVariable> {
   ...
   */
  private resolveTemplaterFunctions(content: string, context: TemplateContext): string {
